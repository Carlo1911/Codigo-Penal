...
public static void main(String[] args){
    ...
    public static void relaciones(Model model, String NS){
        ...
        agregarPropiedadARecurso(libro3, nombre, "Faltas");
        ...
        crearRelacion(model, parricidio,tiene,circunstancias);
        ...
        model.add(veinticinco,agravantes,parentesco);
        defineTipo(model,padre,parentesco);
        // Hechos
